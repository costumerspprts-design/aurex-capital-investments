...
export function Sidebar() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div role="tablist" aria-label="Builder Sections" className="flex border-b text-sm">
        <button
            role="tab"
            id="tab-pages"
      ...
      <div className="p-4 flex-1 overflow-y-auto">
        {tab === 'pages' ? (
            <div role="tabpanel" id="panel-pages" aria-labelledby="tab-pages" className="h-full">
            ...
            <div role="tabpanel" id="panel-assets" aria-labelledby="tab-assets" className="space-y-4">
