  ...
  return (
    <div className="w-full flex items-center justify-between">
      <div className="flex items-center space-x-2">
         <button className="p-2 text-gray-500 hover:bg-gray-100 rounded" title="Desktop View" aria-label="Desktop View"><Monitor size={20} /></button>
         <button className="p-2 text-gray-500 hover:bg-gray-100 rounded" title="Mobile View" aria-label="Mobile View"><Smartphone size={20} /></button>
      </div>
