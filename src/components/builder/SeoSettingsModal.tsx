        ...
        <div className="space-y-4">
            <div>
                ...
                <div className="flex justify-between items-center mt-1">
                    <span className="text-xs text-gray-500">Recommended length: 60 characters</span>
                    <span className={clsx("text-xs font-medium", titleLength > 60 ? "text-red-600" : "text-gray-400")}>
                        {titleLength}/60
                    </span>
                </div>
            </div>
            <div>
                ...
                />
                 <div className="flex justify-between items-center mt-1">
                    <span className="text-xs text-gray-500">Recommended length: 160 characters</span>
                    <span className={clsx("text-xs font-medium", descriptionLength > 160 ? "text-red-600" : "text-gray-400")}>
