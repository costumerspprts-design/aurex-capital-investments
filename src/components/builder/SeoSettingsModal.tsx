        ...
        <div className="space-y-4">
            <div>
                ...
                <div className="flex justify-between text-xs mt-1">
                    ...
                    <span className={clsx("font-medium", activePage.seo.title.length > 60 ? "text-red-500" : "text-gray-500")}>
            ...
            <div>
                ...
                <div className="flex justify-between text-xs mt-1">
                    ...
                    <span className={clsx("font-medium", activePage.seo.description.length > 160 ? "text-red-500" : "text-gray-500")}>
